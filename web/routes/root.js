...
const { phoneNumberFormatter } = require(path_cont + 'format-number');
const axios = require('axios');
const { listDir } = require(path_cont + '/index')
const path = require('path')


router.get('/', async (req, res, next) => {
  return res.render('./template/index', { indexnya: 'index', luarMain: 'index' });
})
